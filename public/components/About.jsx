        ...
        <div id='about' className='xl:py-[150px] lg:py-[100px] md:py-[70px] sm:py-[50px] pt-[50px] py-[30px] relative'>
            <div className='container xl:max-w-[1164px] px-3 mx-auto'>
                <div className='flex flex-row flex-wrap lg:justify-between justify-center items-center'>
                    <div data-aos="zoom-out-right" className='lg:w-[47.7%] md:w-[70%] sm:w-[80%] w-[90%] flex justify-center overflow-hidden rounded-tr-[50px]'>
                    ...
                    <div data-aos="fade-left" className='xl:w-[46.5%] lg:w-[48%] w-full lg:mt-0 mt-10'>
